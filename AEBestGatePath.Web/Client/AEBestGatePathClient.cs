...
using AEBestGatePath.Web.Client.Guilds;
...
namespace AEBestGatePath.Web.Client
{
    ...
    public partial class AEBestGatePathClient : BaseRequestBuilder
    {
        ...
        public global::AEBestGatePath.Web.Client.Guilds.GuildsRequestBuilder Guilds
        {
            get => new global::AEBestGatePath.Web.Client.Guilds.GuildsRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public AEBestGatePathClient(IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}", new Dictionary<string, object>())
        {
            ...
            {
                RequestAdapter.BaseUrl = "https://localhost:44366";
            }
