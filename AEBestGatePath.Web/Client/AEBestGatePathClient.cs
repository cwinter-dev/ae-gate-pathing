...
using AEBestGatePath.API.Client.Accounts;
...
namespace AEBestGatePath.API.Client
{
    ...
    public partial class AEBestGatePathClient : BaseRequestBuilder
    {
        ...
        public global::AEBestGatePath.API.Client.Accounts.AccountsRequestBuilder Accounts
        {
            get => new global::AEBestGatePath.API.Client.Accounts.AccountsRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public AEBestGatePathClient(IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}", new Dictionary<string, object>())
        {
            ...
            {
                RequestAdapter.BaseUrl = "http://localhost:50420";
            }
