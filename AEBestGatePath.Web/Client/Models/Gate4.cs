...
namespace AEBestGatePath.API.Client.Models
{
    ...
    public partial class Gate4 : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::AEBestGatePath.API.Client.Models.Player4? Player { get; set; }
#nullable restore
#else
        public global::AEBestGatePath.API.Client.Models.Player4 Player { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::AEBestGatePath.API.Client.Models.Gate4"/> and sets the default values.
        /// </summary>
        public Gate4()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::AEBestGatePath.API.Client.Models.Gate4"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AEBestGatePath.API.Client.Models.Gate4 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AEBestGatePath.API.Client.Models.Gate4();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "player", n => { Player = n.GetObjectValue<global::AEBestGatePath.API.Client.Models.Player4>(global::AEBestGatePath.API.Client.Models.Player4.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::AEBestGatePath.API.Client.Models.Player4>("player", Player);
