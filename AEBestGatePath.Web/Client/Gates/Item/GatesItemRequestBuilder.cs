...
namespace AEBestGatePath.API.Client.Gates.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::AEBestGatePath.API.Client.Gates.Item.GatesItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::AEBestGatePath.API.Client.Gates.Item.GatesItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::AEBestGatePath.API.Client.Gates.Item.GatesItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
